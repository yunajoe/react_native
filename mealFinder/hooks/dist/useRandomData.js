...
function useRandomData() {
    var _this = this;
    var _a = react_1.useState([]), randomData = _a[0], setRandomData = _a[1];
    var _b = react_1.useState(true), isRandomDataLoading = _b[0], setIsRandomDataLoading = _b[1];
    var _c = react_1.useState(null), isRandomDataError = _c[0], setIsRandomDataError = _c[1];
    ...
    return {
        ...
        isRandomDataError: isRandomDataError,
        isRandomDataLoading: isRandomDataLoading,
        getRanDomFood: getRanDomFood
    };
}
exports["default"] = useRandomData;
