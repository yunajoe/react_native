...
function useDarkMode() {
    ...
    var themeValue = react_1.useMemo(function () {
    ...
    react_1.useEffect(function () {
        ...
        var callBackFunc = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, storage_1.saveNonStringItemToStorage({ key: 'mode', saveValue: themeValue })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return {
        ...
        theme: theme,
        setToggleFunction: setToggleFunction
    };
}
