...
function useSearchData(searchedValue) {
    var _this = this;
    var _a = react_1.useState([]), searchData = _a[0], setSearchData = _a[1];
    var _b = react_1.useState(true), isSearchLoading = _b[0], setIsSearchLoading = _b[1];
    var _c = react_1.useState(null), isError = _c[0], setIsError = _c[1];
    ...
    return {
        ...
        isError: isError,
        getSearchFood: getSearchFood
    };
}
exports["default"] = useSearchData;
