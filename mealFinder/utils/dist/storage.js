    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                itemString = _a.sent();
                if (itemString) {
                    return [2 /*return*/, JSON.parse(itemString)];
                }
                else {
...
exports.saveNonStringItemToStorage = function (_a) {
    var key = _a.key, saveValue = _a.saveValue;
    return __awaiter(void 0, void 0, void 0, function () {
        var value;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    value = JSON.stringify(saveValue);
                    return [4 /*yield*/, exports.saveStringItemToStorage({ key: key, value: value })];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
