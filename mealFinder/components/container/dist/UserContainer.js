...
function UserContainer() {
    ...
    var handleNavigationToNickNameEditScreen = function () {
        navigation.navigate('NickNameEdit');
    };
    var handleNavigationToEmailEditScreen = function () {
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: user_container_style_1.styles.user_container },
        ...
        react_1["default"].createElement(react_native_1.View, { style: user_container_style_1.styles.input_container },
            react_1["default"].createElement(NavigationInput_1["default"], { title: "\uB2C9\uB124\uC784", icon: free_solid_svg_icons_1.faChevronRight, data: authState.username, onPress: handleNavigationToNickNameEditScreen }),
            react_1["default"].createElement(NavigationInput_1["default"], { title: "\uC774\uBA54\uC77C", icon: free_solid_svg_icons_1.faChevronRight, data: authState.email, onPress: handleNavigationToEmailEditScreen }),
